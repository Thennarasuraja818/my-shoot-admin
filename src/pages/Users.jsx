...
import { Search, Eye, Pencil, Trash2, BookOpen, ShieldOff, Mail, Phone, Calendar } from 'lucide-react';
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[#2a2a2a] bg-[#1a1a1a]">
              {['User Instance', 'Identity', 'Metrics', 'Registration', 'Status', 'Management'].map(h => (
              ...
              <tr key={user.id} className="border-b border-[#111] hover:bg-white/5 transition-all group">
                <td className="px-5 py-4">
                  <div className="flex items-center gap-4">
                    <div className="w-11 h-11 rounded-2xl bg-[#f5b400]/10 border border-[#f5b400]/20 flex items-center justify-center text-sm font-black text-[#f5b400] transition-transform group-hover:scale-105">
                      {user.name[0]}
                    </div>
        ...
        {selected && (
          <div className="space-y-6 py-2">
            <div className="flex items-center gap-5">
              <div className="w-20 h-20 rounded-3xl bg-[#f5b400]/10 border border-[#f5b400]/20 flex items-center justify-center text-3xl font-black text-[#f5b400] shadow-2xl">
                {selected.name[0]}
              </div>
            ...
            <div className="bg-[#1a1a1a] rounded-2xl border border-[#2a2a2a] overflow-hidden">
               {[
                 ...
                 <div key={item.label} className={`flex items-center justify-between px-5 py-4 ${i !== 3 ? 'border-b border-[#2a2a2a]' : ''}`}>
                    <div className="flex items-center gap-3">
